...
if( NOT USE_SYSTEM_ITK )
  ...
  ExternalProject_Add( ${proj}
    ...
    CMAKE_ARGS
      ...
      -DITK_INSTALL_LIBRARY_DIR=${CMAKE_INSTALL_LIBDIR} # WHY is this lib???
      -DITK_INSTALL_ARCHIVE_DIR=${CMAKE_INSTALL_LIBDIR}
      -DITK_INSTALL_PACKAGE_DIR=${CMAKE_INSTALL_LIBDIR}/cmake/ITK-${ITK_VERSION}
      # I guess these intermediate libraries may not matter as th content gets moved to the install lib64 anyways?
      #-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=${BINARY_DIR}/${CMAKE_INSTALL_LIBDIR} #  ${ITK_BINARY_DIR}/lib  # so should be the build-directoy with lib appended... how to ge that here
      #-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=${BINARY_DIR}/${CMAKE_INSTALL_LIBDIR}
      # The only other hard coded lib I see in ITK 5.2.1 is for FFTW, FFTW_LIBDIR which is only set internally :/
      ...
      -DCMAKE_INSTALL_RPATH=${SUPERBUILD_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR};@rpath
...
##
set( proj VMTK )
message( "VMTK CMAKE_INSTALL_LIBDIR " ${CMAKE_INSTALL_LIBDIR} )
...
ExternalProject_Add( ${proj}
  ...
  CMAKE_ARGS
    ...
    -DVMTK_BUILD_TESTING:BOOL=${BUILD_TESTING}
    ...
    -DCMAKE_INSTALL_PREFIX:PATH=${SUPERBUILD_INSTALL_PREFIX}
    -DCMAKE_INSTALL_LIBDIR:PATH=${CMAKE_INSTALL_LIBDIR}
    -DVMTK_INSTALL_LIB_DIR:PATH=${CMAKE_INSTALL_LIBDIR}
...
set( VMTK_INSTALL_DIR ${SUPERBUILD_INSTALL_PREFIX} )
